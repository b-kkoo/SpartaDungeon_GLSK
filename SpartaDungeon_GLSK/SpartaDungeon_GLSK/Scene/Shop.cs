...
namespace SpartaDungeon_GLSK.Scene
{
    internal class ShopScene
    {
        ...
        public static bool Shop(out Scenes next, KeyController keyController)
        {
            ...
            Console.WriteLine("1. 포션 상점");
            Console.WriteLine("2. 장비 상점");
            ...
            while (true)
            {
                ...
                {
                    case ConsoleKey.D1:
                        next = Scenes.Main_Menu; //포션 상점으로 이동
                        return true;

                    case ConsoleKey.D2:
                        next = Scenes.Main_Menu; //장비 상점으로 이동
                        return true;
        ...
        public static bool PotionShop(out Scenes next, KeyController keyController, out int selectedIdx)
        {
            ConsoleKey[] keyFilter = new ConsoleKey[] { ConsoleKey.NoName };
            ConsoleKey keyInput;
        ...
        public static bool GearShop(out Scenes next, KeyController keyController, out int selectedIdx)
        {
            ConsoleKey[] keyFilter = new ConsoleKey[] { ConsoleKey.NoName };
            ConsoleKey keyInput;
